...
The second machine learning model used for classification is a K-nearest neighbor classifier. 


\subsection*{Comparison method}

\subsection*{Method for significant of effect of experiments}
...
Using ANOVA, the following results have been gathered for investigating whether the experiment has a significant effect on the resulting curve.

\begin{table}[H]
	\centering
	\begin{tabular}{|l|l|}
		\hline
		Variable       & p-value                         \\ \hline
		Position       & $<2.200 \cdot 10^{-16}$         \\ \hline
		Repetition     & $5.424 \cdot 10^{-7}$           \\ \hline
		Person         & $<2.200 \cdot 10^{-16}$         \\ \hline
		Experiment     & $<2.200 \cdot 10^{-16}$         \\ \hline
	\end{tabular}
\end{table}
