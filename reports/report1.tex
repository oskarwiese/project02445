...
\begin{figure}[H]
	...
	\caption{Histograms for some of the data. In this case a historgram of: x3, x28, x52, x77, x102, y103, y128, y152, y177, y202, z203, z228, z252, z277, z302. The plots show that the variables are normally distributed.}
	\label{fig:normalaf}
\end{figure}
