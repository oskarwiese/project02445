...
\begin{figure}[H]
	...
	\label{fig:exppic}
\end{figure}
The data itself consists of recorded trajectory movements, by measured $ x,y,z $-coordinates in a three dimensional space. An illustration of the coordinates are given in \ref{fig:rplot}.
...
From \ref{fig:boxplotz} it is seen that there is a notable variation in the Z-dimension which indicates that is possible to distinguish each person trajectory arm movements. 
