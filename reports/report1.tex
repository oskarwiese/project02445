...
\begin{figure}[H]
	\centering
	\subfloat[A plot of the first and second principle component]{{\includegraphics[width=4cm]{billeder/pca1.pdf} }}%
	\qquad
	\subfloat[A plot of the thrid and fourth principle component]{{\includegraphics[width=4cm]{billeder/pca2.pdf} }}%
