...
A principle component analysis is done and shows that a great amount of the variance is explained by the first principle components. The first four principle components explains $ 72.1 \% $ of the variation in the data. Therefore, it seems to produce a classifier, which can classify the specific test person from a resulting arm trajectory curve. 
