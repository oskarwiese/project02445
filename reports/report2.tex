...
\subsection*{Does both measurements describe the yield significantly?}
The ANCOVA test showed that both of the measurement techniques has a significant influence on the yield. Based on a level of significance at $ \alpha = 0.05 $ both of the measurements describes the yield significantly. 
